...
export default function CategoryCard({
    ...
    return (
      <Pressable onPress={onPress}>
          ...
          <FlexBox dir="column" key={id} style={{width:165, height:150, border}}width= height="50pt" borderRadius="5pt" margin="15px 10px 15px 10px" alignItems="flex-end" justifyContent="flex-end">
