...
export default function PostCard({
    ...
    return (
        <View style={{width:340, height:165, justifyContent:"center", alignItems:"center", display:"flex", flexDirection:"row"}}>
            ...
            <View style={{width:200, height:165, backgroundColor:"white", overflow:"hidden", alignItems:"space-between", paddingTop:10, paddingLeft:10, paddingBottom:10, paddingRight:10, borderTopRightRadius: 20,borderBottomRightRadius: 20}}>
