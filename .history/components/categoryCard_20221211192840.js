...
export default function CategoryCard({
    ...
    return (
      <Pressable key={key} onPress={onPress} style={{width:"42%", height:140,marginHorizontal:10,marginVertical: 25, shadowOffset:{width:0, height:5}, shadowOpacity:0.4, shadowRadius:5}}>
