...
export default function CategoryCard({
    ...
    return (
      <Pressable key={id}>
          <FlexBox dir="column" style={{width:155, height:140, borderRadius:5, borderWidth:0, alignItems:"flex-end", justifyContent:"flex-end", onPress={onPress}marginHorizontal:10,marginVertical: 15}}>
