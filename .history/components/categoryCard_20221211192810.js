...
export default function CategoryCard({
    ...
    return (
      <Pressable key={key} onPress={onPress} style={{width:"46%", height:140,marginHorizontal:10,marginVertical: 15, shadowOffset:{width:0, height:5}, shadowOpacity:0.4, shadowRadius:5}}>
