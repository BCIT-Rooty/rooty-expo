...
export default function PostCard({
    ...
    return (
        <View style={{width:340, height:165, backgroundColor:"#FF9788", justifyContent:"center", alignItems:"center", display:"flex", flexDirection:"row"}}>
            {/* <View style={{display:"flex", flexDirection:"row"}}> */}
                <Image style={{width:140,height:165, borderTopLeftRadius: 20,borderBottoomLeftRadius: 20,}} source={{uri:url}}/>
