...
export default function CategoryCard({
    ...
    return (
      <Pressable onPress={onPress} style={{width:"42%", height:140,marginHorizontal:10,marginVertical: 25, shadowOffset:{width:0, height:5}, shadowOpacity:0.4, shadowRadius:5}}>
        <View key={key} style={{display:"flex", flexDirection:"column", borderTopLeftRadius:20, borderTopEndRadius:20, borderWidth:0, alignItems:"flex-end", justifyContent:"flex-end"}}>
