...
export default function PostCard({
    ...
    return (
        <View style={{width:340, height:165, justifyContent:"center", alignItems:"center", display:"flex", flexDirection:"row", shadowOffset:{width:0, height:10}, shadowOpacity:0.4, shadowRadius:5}}>
