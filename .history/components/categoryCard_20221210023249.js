...
export default function CategoryCard({
    ...
    return (
      <Pressable onPress={onPress}>
          <FlexBox dir="column" key={id} style={{width:155, height:140, borderRadius:5, borderWidth:0, alignItems:"flex-end", justifyContent:"flex-end", marginHorizontal:15,marginVertical: 15}}>
