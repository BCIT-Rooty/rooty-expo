...
export default function CategoryCard({
    ...
    return (
      <Pressable key={} onPress={onPress}>
          <FlexBox dir="column" key={id} style={{width:155, height:140, borderRadius:5, borderWidth:0, alignItems:"flex-end", justifyContent:"flex-end", marginHorizontal:10,marginVertical: 15}}>
