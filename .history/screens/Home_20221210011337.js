...
export default function Home() {
  ...
  return (
     <View style={{border:"0px", width:"100%", padding:"20px", height:"100%"}}>
      <View style={{width:"100%", justifyContent:"start", alignItems:"flex-start" border="0px" padding="50px 0 7px 20px" minHeight="100px"}}></View>
          <FlexBox width="100%" justifyContent="start" alignItems="flex-start" border="0px" padding="50px 0 7px 20px" minHeight="100px">
