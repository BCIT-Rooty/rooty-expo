...
export default function BroadcastMedia() {
  ...
  return ( 
    <KeyboardAvoidingView behaviour="padding" style={{display:"flex", justifyContent:"start", alignItems:"center", height:"100%", paddingTop: 50}}>
      ...
      <Image style={{width:"100%", height:300, tintColor:"rgba(79, 77, 176, 0.5)", position:"absolute", top: 50}} source={{uri:"https://starbooks.ca/wk06website/wp-content/uploads/2022/12/broadcast-500x500.png"}}></Image>
