...
export default function Home() {
  ...
  return (
     <View style={{borderWidth:0, width:"100%", padding:"20px", height:"100%", backgroundColor:"#F8F6F2"}}>
          <View style={{width:"100%", justifyContent:"end", alignItems:"end", paddingTop:50, paddingRight:0, paddingLeft:20, minHeight:100, borderBottomWidth: 1, borderBottomColor: 'grey', marginBottom:20}}>
