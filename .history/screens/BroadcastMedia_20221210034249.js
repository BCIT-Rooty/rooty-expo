  ...
  return ( 
    ...
    <ScrollView style={{marginTop:50}}>
        {go === true && cards.map((o,i)=>( <View key={i} style={{marginBottom:30}}>
            {i % 2 === 0 && <PostCard format="left" url={o.url} title={o.title} description={o.description}/>}
            {i % 2 !== 0 && <PostCard format="right" url={o.url} title={o.title} description={o.description}/>}
            </View>
        ))}
    </ScrollView>
