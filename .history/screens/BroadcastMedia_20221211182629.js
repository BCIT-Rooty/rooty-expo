...
export default function BroadcastMedia() {
  ...
  return ( 
    <KeyboardAvoidingView behaviour="padding" style={{display:"flex", justifyContent:"start", alignItems:"start", height:"100%", paddingTop: 50}}>
      ...
      <Image style={{width:"100%", height:300, tintColor:"rgba(79, 77, 176, 0.8)", position:"absolute", top: 50}}></Image>
      <BackButton style={{position:"absolute", top:60, left:20}} onPress={hey}></BackButton>
      <Text style={{position:"absolute", top:300, left:20, fontSize:24, color:"white", fontWeight:"800", width:"100%"}}>Broadcast & Media</Text>
