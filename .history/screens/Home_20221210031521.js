...
export default function Home() {
  ...
  return (
     <View style={{borderWidth:0, width:"100%", padding:"20px", height:"100%", backgroundColor:"#FAF9F6"}}>
          ...
          {listOfCategories.map((category) => (
              <CategoryCard onPress={()=>{SendRoute(category.id)}} name={category.name} image={category.image}></CategoryCard>
