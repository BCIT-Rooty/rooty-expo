...
export default function Home() {
  ...
  return (
     <View style={{borderWidth:0, width:"100%", padding:"20px", height:"100%"}}>
          <View style={{width:"100%", justifyContent:"start", alignItems:"flex-start", paddingTop:50, paddingRight:0, paddingBottom:7, paddingLeft:20, minHeight:100, borderBottomWidth: 2}}>
