...
export default function Home() {
  ...
  return (
     <View style={{borderWidth:"0px", width:"100%", padding:"20px", height:"100%"}}>
          <View style={{width:"100%", justifyContent:"start", alignItems:"flex-start", borderWidth:0, padding:"50px 0px 7px 20px", minHeight:100}}>
